workdir = "workdir"
tag = "pretrain_day_dj30_17_dynamic_single_vqvae_time_series_200e_h8_cb256_nllmean"
...
use_quantized_only_for_factors = True
nll_reduction = "mean_like_ret"
...
vae = dict(
    type = "DynamicSingleVQVAE",
    embed_config=embed_config,
    config=config,
    asset_num=num_assets,
    use_quantized_only_for_factors=use_quantized_only_for_factors,
)
...
trainer = dict(
    type = "DynamicSingleVQVAETrainer",
    config = None,
    vae = None,
    vae_ema = None,
    dit = None,
