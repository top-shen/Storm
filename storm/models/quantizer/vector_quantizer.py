...
@QUANTIZER.register_module(force=True)
    ...
    def forward(
        ...
        if self.training:
            ...
            if self.has_commitment_loss:
                ...
                weighted_commit_loss = commit_loss * self.commitment_weight

                loss = loss + weighted_commit_loss
            ...
            if self.has_codebook_orthogonal_loss:
                ...
                weighted_orthogonal_reg_loss = orthogonal_reg_loss * self.orthogonal_reg_weight

                loss = loss + weighted_orthogonal_reg_loss
